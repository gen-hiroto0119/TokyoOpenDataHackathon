 ...
 * 改札 6（3 路線ぶん）、集合候補 3、出口 2、階段 1 本。
...
const catalog: Catalog = {
  ...
  exits: [
    { catalogId: "exit.west", nodeId: "e.west", nameJa: "西口地上出口", lat: 35.6896, lng: 139.6985 },
    { catalogId: "exit.east", nodeId: "e.east", nameJa: "東口地上出口", lat: 35.6912, lng: 139.7035 },
  ],
  destinations: [
